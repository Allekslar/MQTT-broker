...
The intended growth path for this project is:
...
We first build **one well-structured node** that:
- tests well
...
The single-broker mode must first become dependable:
- no leaks
- no hangs
