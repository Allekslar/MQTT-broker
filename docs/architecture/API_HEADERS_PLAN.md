...
components/
  ...
  subscription_index/include/subscription_index/
  qos/include/qos/
...
### 7.7. `subscription_index.hpp`

Should expose:
- subscription add/remove/query API if the module is instantiated independently of `routing`
- bounded subscription-view or lookup result types where part of the public module contract
