...
- **low-level edge code may use C or C-like C++ when appropriate**
...
## 12.7. `subscription_index`

Responsible for:
- subscription add/remove/update operations
- topic-filter lookup and matching support for routing
- stable views over bounded subscription state
...
This stack is best suited to support:
- clean architecture
- modularity
- testability
- resource control
