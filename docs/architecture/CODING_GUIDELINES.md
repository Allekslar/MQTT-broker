...
- testable
- resource-aware
- able to evolve from `single-broker mode` to `federated multi-broker mode`
...
- skipped intermediate versions must be migrated sequentially, not inferred implicitly
