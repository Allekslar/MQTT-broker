...
This document defines the practical team workflow for architecture rules, local checks, and PR discipline.
...
- whether test-only access remains in dedicated `*_test_access.hpp` headers where required
